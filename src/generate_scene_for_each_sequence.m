...
%
% Parameters:
% points -- num_frames x num_points x 3 x num_sequences

function scenes = generate_scene_for_each_sequence(sequences, omega_stddev, ...
    scale_stddev)
  ...
  scenes = cellfun(...
      @(sequence) generate_scene_for_sequence(sequence, omega_stddev, ...
        scale_stddev), ...
      sequences);
end
