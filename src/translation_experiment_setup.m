...
solvers = [...
  ...
  struct(...
    'f', @(equations) find_structure_constrained_translation(equations, ...
      extrinsics, 0.1, true, settings), ...
    'name', 'Centroid per frame (\gamma = 0.1)', ...
    'id', 'constrained-0.1'), ...
  struct(...
    'f', @(equations) find_structure_constrained_translation(equations, ...
      extrinsics, 0.3, true, settings), ...
    'name', 'Centroid per frame (\gamma = 0.3)', ...
    'id', 'constrained-0.3'), ...
  struct(...
    'f', @(equations) find_structure_constrained_translation(equations, ...
      extrinsics, 1.0, true, settings), ...
    'name', 'Centroid per frame (\gamma = 1.0)', ...
    'id', 'constrained-1.0'), ...
];
