...
%   nrsfm_balm_approximate(projections, rotations, basis, max_iter)
%
% Parameters:
...
function [structure, rotations, basis, coeff] = nrsfm_balm_approximate(...
    projections, rotations, coeff, rho, max_iter, mu, tau_incr, tau_decr)
  ...
  while ~converged && num_iter < max_iter
    ...
    for t = 1:F
      V_t = V(:, :, :, t);
      [N_t, c_t, R_t] = project_motion_manifold_approx(V_t);
      N(:, t, :, :) = N_t;
      % For output.
      coeff(:, t) = c_t;
      rotations(:, :, t) = R_t;
